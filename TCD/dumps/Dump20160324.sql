...
--
-- Temporary view structure for view `v_character_list`
--

DROP TABLE IF EXISTS `v_character_list`;
/*!50001 DROP VIEW IF EXISTS `v_character_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_character_list` AS SELECT 
 1 AS `CHARACTER_NAME`,
 1 AS `CHARACTER_USER`,
 1 AS `ROLE_NAME`*/;
...
--
-- Final view structure for view `v_character_list`
--
...
/*!50001 VIEW `v_character_list` AS select `cha`.`CHARACTER_NAME` AS `CHARACTER_NAME`,`cha`.`CHARACTER_USER` AS `CHARACTER_USER`,`rol`.`ROLE_NAME` AS `ROLE_NAME` from (`t_characters` `cha` join `t_role` `rol` on((`cha`.`CHARACTER_ROLE` = `rol`.`ID_ROLE`))) */;
...
-- Dump completed on 2016-03-24 15:37:17
